...
<script>
    // 引入轮播图图片
    import carouselImg1 from '../../assets/image/young/young1.jpg';
    import carouselImg2 from '../../assets/image/young/young2.jpg';
    import carouselImg3 from '../../assets/image/young/young3.jpg';
    import carouselImg4 from '../../assets/image/young/young4.jpg';
    export default {
        name: 'young',
        data () {
            return {
        ...
        created () {
            ...
            this.$http.get(this.GlobalVar.apiConfig.novel.getByTypeOrStatus + '?' + 'str=青春&offset=' + 0 + '&last=20')
                .then(
                    res => {

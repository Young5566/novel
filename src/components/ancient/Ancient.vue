...
<script>
    // 引用轮播图
    import carouselImg1 from '../../assets/image/ancient/an1.jpg';
    import carouselImg2 from '../../assets/image/ancient/an2.jpg';
    import carouselImg3 from '../../assets/image/ancient/an3.jpg';
    import carouselImg4 from '../../assets/image/ancient/an4.jpg';
    export default {
        name: 'ancient',
        data () {
            return {
        ...
        // 进入页面后的数据初始化
        created () {
            this.$http.get(this.GlobalVar.apiConfig.novel.getByTypeOrStatus + '?' + 'str=古言&offset=' + 0 + '&last=20')
                .then(
                    res => {

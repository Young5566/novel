...
<script>
    // 引入轮播图图片
    import carouselImg1 from '../../assets/image/suspense/sus1.jpg';
    import carouselImg2 from '../../assets/image/suspense/sus2.jpg';
    import carouselImg3 from '../../assets/image/suspense/sus3.jpg';
    import carouselImg4 from '../../assets/image/suspense/sus4.jpg';
    export default {
        name: 'suspense',
        data () {
            return {
        ...
        // 数据的初始化
        created () {
            this.$http.get(this.GlobalVar.apiConfig.novel.getByTypeOrStatus + '?' + 'str=悬疑&offset=' + 0 + '&last=20')
                .then(
                    res => {
                        // console.log(res.data);
                        if (res.data.code === 200) {

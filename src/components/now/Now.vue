...
<script>
    import carouselImg1 from '../../assets/image/now/now1.jpg';
    import carouselImg2 from '../../assets/image/now/now2.jpg';
    import carouselImg3 from '../../assets/image/now/now3.jpg';
    import carouselImg4 from '../../assets/image/now/now4.jpg';
    export default {
        name: 'now',
        data () {
            return {
        ...
        methods: {
            ...
            // 分页调用的函数
            getContent (offset) {
                this.$http.get(this.GlobalVar.apiConfig.novel.getByTypeOrStatus + '?' + 'str=现言&offset=' + offset * 20 + '&last=20')
                    .then(
                        res => {
        ...
        created () {
            ...
            this.$http.get(this.GlobalVar.apiConfig.novel.getByTypeOrStatus + '?' + 'str=现言&offset=' + 0 + '&last=20')
                .then(
                    res => {
                        // console.log(res.data);
                        if (res.data.code === 200) {
